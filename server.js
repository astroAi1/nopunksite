    ...
    items: [
      {
        ...
        format: 'json',
        url: toAbsoluteUrl(origin, '/explorer-data/onchain_traits.json'),
      ...
      },
      {
        ...
        format: 'json',
        url: toAbsoluteUrl(origin, '/explorer-data/token_trait_blob.json'),
      ...
      },
      {
        ...
        format: 'json',
        url: toAbsoluteUrl(origin, '/explorer-data/trait_to_token_ids.json'),
      ...
      },
      {
        ...
        format: 'svg',
        url: toAbsoluteUrl(origin, `/explorer-data/images/${PUBLIC_SAMPLE_TOKEN_ID}.svg`),
        generatedAt: onchainTraits?.generatedAt || null,
      },
    ],
  };
